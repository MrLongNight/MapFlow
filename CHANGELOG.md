...
## [Unreleased]
- 2026-02-12: fix(render): Downgrade wgpu to 23.0.1 and resolve API compatibility issues
- 2026-02-10: feat(bevy): Add 3D Text Node with customizable content, size, color, and alignment (#663)
