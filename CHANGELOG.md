...
- 2026-02-28: fix(ci): Fix FFmpeg header detection on Linux by explicitly setting include/lib paths and resolve vcpkg manifest error on Windows in Release workflow.
