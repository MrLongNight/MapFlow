...
**Erkenntnis:** `MidiMessage` parsing logic for PitchBend (14-bit reconstruction) was implemented but untested. This created a risk for hardware controllers relying on high-resolution input or transport controls.
