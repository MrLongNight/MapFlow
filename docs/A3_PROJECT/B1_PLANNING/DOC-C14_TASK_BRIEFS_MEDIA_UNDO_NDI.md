...
- `QA-Status` in den GitHub Project Issues nicht aendern.
...
- In `crates/vorce-media/src/decoder.rs` existiert der konkrete Fehlerpfad:
...
- `crates/vorce-core/src/history.rs` verwaltet `AppState`-Snapshots.
- `crates/vorce-ui/src/core/undo_redo.rs` enthaelt ein separates Command-System.
- Der real genutzte Module-Canvas-Pfad arbeitet ueber `ModuleCanvas.undo_stack` / `redo_stack`.
- `CanvasAction` in `crates/vorce-ui/src/editors/module_canvas/types.rs` kennt derzeit vor allem:
  - `AddPart`
  - `DeletePart`
  - `MovePart`
  - `AddConnection`
...
- `crates/vorce-ui/src/editors/module_canvas/types.rs`
- `crates/vorce-ui/src/editors/module_canvas/state.rs`
- `crates/vorce-ui/src/editors/module_canvas/controller.rs`
...
- `crates/vorce-io/src/ndi/mod.rs` enthaelt bereits:
  - `discover_sources`
...
- Im Module Canvas existiert bereits NDI-bezogener UI-State:
  ...
  - `ndi_discovery_rx`
  - `pending_ndi_connect`
- `UIAction::ConnectNdiSource` existiert bereits in `crates/vorce-ui/src/lib.rs`.
- Die eigentliche Runtime-Verarbeitung des Connects existiert bereits in `crates/vorce/src/app/actions.rs`.
...
- `crates/vorce-io/src/ndi/mod.rs`
- `crates/vorce-ui/src/editors/module_canvas/inspector/source.rs`
