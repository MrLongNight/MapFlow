...
Vorce nutzt `wgpu` für das Rendering. Der Austausch von Videodaten mit anderen Applikationen (NDI, Spout) erfordert effiziente Übergänge zwischen GPU-Kontexten oder schnelles Readback in den RAM.
...
2.  Implementierung eines `SpoutSender` Moduls in `vorce-io`.
