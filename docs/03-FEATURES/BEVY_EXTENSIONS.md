...
| **🧊 3D Shape** | `Mesh3d` | ✅ Aktiv | Primitive Formen (Cube, Sphere, etc.). | Type, Color, Scale, Unlit. |
...
### Bevy 3D Shape
Einfache geometrische Primitive direkt in MapFlow.
- **Formen**: Cube, Sphere, Capsule, Torus, Cylinder, Plane.
- **Material**: Farbe und Unlit-Modus.
