...
Der Workflow `JULES-01_create-issues.yml` ist als **`workflow_dispatch`** konfiguriert:
...
curl -X POST \
  ...
  https://api.github.com/repos/MrLongNight/VjMapper/actions/workflows/JULES-01_create-issues.yml/dispatches \
