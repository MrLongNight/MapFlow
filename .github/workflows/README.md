...
This directory contains automated workflows for the SubI project, implementing a comprehensive CI/CD pipeline with Jules AI integration.
...
**Grund:**  
SubI verwendet bewusst nur noch einen zentralen Auto-Merge-Mechanismus über `CICD-DevFlow_Job02_AutoMerge.yml`, damit keine widersprüchlichen Zustände zwischen GitHub Auto-Merge und eigenem Workflow entstehen.
