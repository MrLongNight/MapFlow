...
mod tests {
    ...
    fn test_socket_update_cleanup() {
        ...
        // Use clone to avoid move error if add_part_with_type takes ownership
        let p1 = module.add_part_with_type(fft_part_type.clone(), (0.0, 0.0));
        // Add a second part with the same type (simulating duplicate/multiple triggers)
        let _p3 = module.add_part_with_type(fft_part_type, (0.0, 0.0));
        let p2 = module.add_part(PartType::Layer, (100.0, 0.0));
