                                ...
                                egui::ScrollArea::vertical().show(ui, |ui| {
                                    ...
                                    egui::CollapsingHeader::new("🔊 Audio")
                                        ...
                                        .show(ui, |ui| {
                                            ...
                                            let audio_ctx = mapmap_ui::audio_panel::AudioPanelContext {
                                                locale: &self.ui_state.i18n,
                                                analysis: Some(&analysis),
                                                current_config: &self.state.audio_config,
                                                audio_devices: &self.audio_devices,
                                                selected_audio_device: &mut self.ui_state.selected_audio_device,
                                            };

                                            if let Some(action) = self.ui_state.audio_panel.ui(ui, audio_ctx) {
                                                match action {
