    ...
    CategoryType: CategoryTrait,
{
    ...
    fn draw_graph_editor_inside_zoom(
        ...
        let mut secondary_click_on_background = false;
        ...
        if r.clicked() {
            ...
            secondary_click_on_background = true;
        }
        ...
        for node_id in self.node_order.iter().copied() {
            let responses = GraphNodeWidget {
                ...
                selected: self
                    .selected_nodes.contains(&node_id),
        ...
        if let Some(ref mut node_finder) = self.node_finder {
            let mut node_finder_area =
                Area::new(egui::Id::new("node_finder")).order(Order::Foreground);
    ...
    DataType: DataTypeTrait<UserState>,
{
    ...
    fn show_graph_node(
        ...
        let (shape, outline) = {
            ...
            let corner_radius = CornerRadius::same(rounding_radius as u8);
