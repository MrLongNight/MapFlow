...
audio-gain-low = Low-Band Verstärkung
audio-gain-mid = Mid-Band Verstärkung
audio-gain-high = High-Band Verstärkung
audio-smoothing = Glättung
audio-rms = RMS Lautstärke
audio-peak = Peak Lautstärke
audio-beat = Beat
...
media = Medien
timeline = Zeitachse
media-sidebar-placeholder = Wählen Sie ein Modul oder Medium...
...
hw-accel = Hardware-Beschleunigung
target-fps = Ziel-Bildrate
texture-quality = Texturqualität
hue-status = Philips Hue Status
hue-discover = Bridges suchen
hue-disconnect = Trennen
