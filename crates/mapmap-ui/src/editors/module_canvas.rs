                                ...
                                match &mut part.part_type {
                                    ...
                                    ModulePartType::Source(source) => {
                                        ...
                                        match source {
                                            ...
                                            SourceType::BevyAtmosphere { .. } => { ui.label("☁️ Atmosphere Settings (TODO)"); }
                                            SourceType::BevyHexGrid { .. } => { ui.label("⬢ Hex Grid Settings (TODO)"); }
                                            SourceType::BevyParticles { .. } => { ui.label("✨ Particles Settings (TODO)"); }
