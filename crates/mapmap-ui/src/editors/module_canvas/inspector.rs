                            ...
                            SourceType::Bevy3DShape {
                                ...
                                ui.horizontal(|ui| {
                                    ...
                                    egui::ComboBox::from_id_salt("shape_type_select")
                                        ...
                                        .show_ui(ui, |ui| {
                                            ui.selectable_value(shape_type, BevyShapeType::Cube, "Cube");
                                            ui.selectable_value(shape_type, BevyShapeType::Sphere, "Sphere");
                                            ui.selectable_value(shape_type, BevyShapeType::Capsule, "Capsule");
                                            ui.selectable_value(shape_type, BevyShapeType::Torus, "Torus");
                                            ui.selectable_value(shape_type, BevyShapeType::Cylinder, "Cylinder");
                                            ui.selectable_value(shape_type, BevyShapeType::Plane, "Plane");
                                        });
                                });
