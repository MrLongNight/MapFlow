...
impl ModuleCanvas {
                                    ...
                                    ModulePartType::Source(source) => {
                                        ui.horizontal(|ui| {
                                            ...
                                            let current_mode = match source {
                                                ...
                                                SourceType::Bevy3DModel { .. } => "\u{1F9CA} 3D Model",
                                        ...
                                        match source {
                                            ...
                                            SourceType::Bevy3DModel { .. } => { ui.label("3D Model Settings Placeholder"); },
    ...
    fn render_add_node_menu_content(
        ...
        ui.menu_button("\u{1F3AC} Sources", |ui| {
    ...
    fn get_part_property_text(part_type: &mapmap_core::module::ModulePartType) -> String {
        ...
        match part_type {
            ...
            ModulePartType::Source(source_type) => match source_type {
                ...
                SourceType::Bevy3DModel { .. } => "\u{1F9CA} 3D Model".to_string(),
            },
