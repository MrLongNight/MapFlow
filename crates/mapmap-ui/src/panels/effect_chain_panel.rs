                ...
                let header_response = egui::Frame::default()
                    ...
                    .show(ui, |ui| {
                        ui.horizontal(|ui| {
                            ...
                            // Drag Handle (Custom)
                            let (rect, resp) =
                                ui.allocate_at_least(egui::vec2(12.0, 20.0), egui::Sense::drag());
                            ...
                            } else if ui.button(header_text).clicked() {
                                expanded = !expanded;
                            }
