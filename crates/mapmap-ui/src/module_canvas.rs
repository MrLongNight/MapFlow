                                                ...
                                                if path.is_empty() {
                                                    ui.vertical_centered(|ui| {
                                                        ...
                                                        if ui.add(egui::Button::new(
                                                            egui::RichText::new("Select Media File")
                                                                .size(16.0)
                                                                .strong()
                                                        ).min_size(Vec2::new(160.0, 40.0))).clicked() {
                                                            actions.push(crate::UIAction::PickMediaFile(module.id, part_id));
                                                        }

                                                        ui.add_space(10.0);
                                                        ui.label(egui::RichText::new("Supported: .mp4, .mov, .mkv, .webm").color(Color32::from_gray(120)).size(11.0));
                                                        ui.add_space(10.0);
                                                    });
                                                } else {
