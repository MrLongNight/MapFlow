...
use mapmap_core::{
    ...
    module::{
        AudioBand, BlendModeType, EffectType as ModuleEffectType, LayerAssignmentType,
...
impl ModuleCanvas {
                                ...
                                match &mut part.part_type {
                                    ModulePartType::Trigger(trigger) => {
                                        ...
                                        match trigger {
                                            ...
                                            TriggerType::AudioFFT { threshold } => {
                                                ui.label("🔊 Audio FFT");
                                    ...
                                    ModulePartType::Mask(mask) => {
                                        ...
                                        match mask {
                                            ...
                                            MaskType::Shape(shape) => {
                                                ui.label("🔷 Shape Mask");
                                                egui::ComboBox::from_id_source("mask_shape")
    ...
    fn get_audio_trigger_state(
        ...
        match part_type {
            ModulePartType::Trigger(TriggerType::AudioFFT { threshold }) => {
                // For the glow effect, we check if any band is over the threshold.
                // The "value" will be the maximum energy of any band.
                let max_energy = self
                    .audio_trigger_data
                    .band_energies
                    .iter()
                    .fold(0.0f32, |a, &b| a.max(b));
                let is_active = max_energy > *threshold;
                (true, max_energy, *threshold, is_active)
            }
